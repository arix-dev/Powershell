...
===========================================================================
.DESCRIPTION
 Removes stubborn pipeline from Azure DevOps
#>

$organization = "rixworx"
$project = "PythonWeb"
$personalAccessToken = Read-Host("Enter Personal Access Token")
$token = [System.Convert]::ToBase64String([System.Text.Encoding]::ASCII.GetBytes(":$($personalAccessToken)"))
$header = @{authorization = "Basic $token"}

$pipelineName = Read-Host("Enter Stubborn pipeline to delete")
